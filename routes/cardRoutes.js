...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    // Generate the new quote_id by incrementing the last card's quote_id instances accordingly
    ...
    const card = new Card({
      ...
      billing_address, // and all others billing address things
      billing_city,
      billing_state,
      billing_zip,
      card_name,
    ...
    const newCard = await card.save(); // new cards are happning soons
...
router.put("/:id", async (req, res) => {
  try {
    ...
    if (req.body.billing_address != null)
      card.billing_address = req.body.billing_address;
    if (req.body.billing_city != null)
      card.billing_city = req.body.billing_city;
    if (req.body.billing_state != null)
      card.billing_state = req.body.billing_state;
