...
router.post('/', async (req, res) => {
  try {
    ...
    const { quote_id, carrier_name, carrier_company_phone, carrier_company_email, carrier_mc_num, driver_name, driver_phone, carrier_routes } = req.body;
    ...
    if (existingCarrier) {
      ...
      return res.status(400).json({ message: 'A carrier with this quote_id already exists.' });
    }
